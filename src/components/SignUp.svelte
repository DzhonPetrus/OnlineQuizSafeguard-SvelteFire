<script>
    ...
    const register = () => {
        let newAccount;
        // TODO VALIDATE DATA THEN PASS TO SignUp
...
<div class="flex items-center justify-center w-full mb-12 mt-4">
    <div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-600 sm:px-6 md:px-8 lg:px-10">
        ...
        <span class="justify-center text-sm text-center text-gray-500 flex-items-center dark:text-gray-400">
            ...
            <a on:click={() => dispatch('changeState',{})}  class="cursor-pointer text-sm text-blue-500 underline hover:text-blue-700">
                Sign in
            </a>
        </span>
        <div>
            <a href="#" class="flex items-center justify-center mt-4 text-gray-600 rounded-lg shadow-md dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <span on:click={() => dispatch('signUpGoogle',{})} class="w-5/6 px-4 py-3 font-bold text-center">Sign up with Google</span>
            </a>
        </div>
        <div class="mt-8">
  ...
  <path fill-rule="evenodd" d="M14.243 5.757a6 6 0 10-.986 9.284 1 1 0 111.087 1.678A8 8 0 1118 10a3 3 0 01-4.8 2.401A4 4 0 1114 10a1 1 0 102 0c0-1.537-.586-3.07-1.757-4.243zM12 10a2 2 0 10-4 0 2 2 0 004 0z" clip-rule="evenodd" />
                        ...
                        <input required name="email" type="email" class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="Your new email"/>
                    </div>
                </div>
                <div class="flex flex-col mb-4">
                    <div class="flex relative ">
